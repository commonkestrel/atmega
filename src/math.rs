//! Bindings for float intrinsics not included in core.

use core::intrinsics;

/// Re-exports of `libm` functions.
mod cmath {
    /// `libm` functions for `f64`, or `double`
    pub mod f64 {
        extern "C" {
...
impl Float for f64 {
	...
	fn abs_sub(self, other: f64) -> f64 {
		unsafe { cmath::f64::fdim(self, other) }
	}
	#[inline]
	fn cbrt(self) -> f64 {
		unsafe { cmath::f64::cbrt(self) }
	}
	#[inline]
	fn hypot(self, other: f64) -> f64 {
		unsafe { cmath::f64::hypot(self, other) }
	}
	#[inline]
	fn sin(self) -> f64 {
	...
	#[inline]
	fn tan(self) -> f64 {
		unsafe { cmath::f64::tan(self) }
	}
	#[inline]
	fn asin(self) -> f64 {
		unsafe { cmath::f64::asin(self) }
	}
	#[inline]
	fn acos(self) -> f64 {
		unsafe { cmath::f64::acos(self) }
	}
	#[inline]
	fn atan(self) -> f64 {
		unsafe { cmath::f64::atan(self) }
	}
	#[inline]
	fn atan2(self, other: f64) -> f64 {
		unsafe { cmath::f64::atan2(self, other) }
	}
	#[inline]
	...
	#[inline]
	fn exp_m1(self) -> f64 {
		unsafe { cmath::f64::expm1(self) }
	}
	#[inline]
	fn ln_1p(self) -> f64 {
		unsafe { cmath::f64::log1p(self) }
	}
	#[inline]
	fn sinh(self) -> f64 {
		unsafe { cmath::f64::sinh(self) }
	}
	#[inline]
	fn cosh(self) -> f64 {
		unsafe { cmath::f64::cosh(self) }
	}
	#[inline]
	fn tanh(self) -> f64 {
		unsafe { cmath::f64::tanh(self) }
	}
	#[inline]
	fn asinh(self) -> f64 {
...
impl Float for f32 {
	...
	fn abs_sub(self, other: f32) -> f32 {
		unsafe { cmath::f32::fdimf(self, other) }
	}
	#[inline]
	fn cbrt(self) -> f32 {
		unsafe { cmath::f32::cbrtf(self) }
	}
	#[inline]
	fn hypot(self, other: f32) -> f32 {
		unsafe { cmath::f32::hypotf(self, other) }
	}
	#[inline]
	fn sin(self) -> f32 {
	...
	#[inline]
	fn tan(self) -> f32 {
		unsafe { cmath::f32::tanf(self) }
	}
	#[inline]
	fn asin(self) -> f32 {
		unsafe { cmath::f32::asinf(self) }
	}
	#[inline]
	fn acos(self) -> f32 {
		unsafe { cmath::f32::acosf(self) }
	}
	#[inline]
	fn atan(self) -> f32 {
		unsafe { cmath::f32::atanf(self) }
	}
	#[inline]
	fn atan2(self, other: f32) -> f32 {
		unsafe { cmath::f32::atan2f(self, other) }
	}
	#[inline]
	...
	#[inline]
	fn exp_m1(self) -> f32 {
		unsafe { cmath::f32::expm1f(self) }
	}
	#[inline]
	fn ln_1p(self) -> f32 {
		unsafe { cmath::f32::log1pf(self) }
	}
	#[inline]
	fn sinh(self) -> f32 {
		unsafe { cmath::f32::sinhf(self) }
	}
	#[inline]
	fn cosh(self) -> f32 {
		unsafe { cmath::f32::coshf(self) }
	}
	#[inline]
	fn tanh(self) -> f32 {
		unsafe { cmath::f32::tanhf(self) }
	}
	#[inline]
	fn asinh(self) -> f32 {
